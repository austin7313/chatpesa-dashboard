            ...
            {filteredOrders.length === 0 ? (
              ...
              filteredOrders.map((order) => (
                ...
                >
                  ...
                  <td style={{ padding: 12 }}>{order.customer_name || order.customer_phone}</td>
      ...
      {selectedOrder && (
        ...
        >
          ...
          >
            ...
            <p><b>Name:</b> {selectedOrder.customer_name || selectedOrder.customer_phone}</p>
            ...
            <p><b>Time:</b> {selectedOrder.paid_at
                      ? new Date(selectedOrder.paid_at).toLocaleString()
                      : new Date(selectedOrder.created_at).toLocaleString()}</p>
